    ...
    def play(self):
        ...
        for game_number in range(1, games_to_play + 1):
            ...
            while player_hand.get_value() < 21 and choice not in ["s", "stand"]:
                choice = input("Type in 'hit' or 'stand': ").lower()
                print()
                while choice not in ["hit", "stand", "s", "h"]:
                    choice = input("Type in 'hit' or 'stand' (or H/S) : ").lower()
                    print()
                if choice in ["hit", "h"]:
                    player_hand.add_card(deck.deal(1))
                    player_hand.display()
                ...
                if self.check_win(player_hand, dealer_hand):
                    break  # Use break instead of continue here
